module.exports = {
	...
	adminId: "1375629140341952552", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTQ1NzU5ODIwMTI0MTUzNDUwOQ.GnwLoL.9HGHGqRh8N_GVxk4dGxyzrhh1Xq3kb6y_dFh0o", //- Bot's Token
	clientId: process.env.clientId || "1457598201241534509", //- ID of the bot
	clientSecret: process.env.clientSecret || "yzeo0HaOZsZXDg9CT0q-K_K2kGss6Oe9", //- Client Secret of the bot
